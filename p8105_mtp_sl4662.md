...
size (10-25mm) and FHP size (40-50mm) are misplaced.

In Fig.4, most observations in these two groups are misplaced and making
conclusion based on in EOP size 0 mm and EOP size 0-5 mm group will give
wrong results.
