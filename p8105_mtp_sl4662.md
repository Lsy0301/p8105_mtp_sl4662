...
Firs step is to put categorical and continuous variables in appropriate
...
There are 9 variables and 1221 observations in this data set. There are
...
It shows that there are more participants in `age_group` 18-30 and 60+.
Two participants are included in `age_group` 1 by mistake.
