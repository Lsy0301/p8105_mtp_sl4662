...
# Problem 2
reorder(fhp_size_mm, age)  coord_flip()+ 
```{r}
...
ggplot(data = mtp_data, aes(x = fhp_size_mm, y = age, color = sex)) + 
  geom_point(aes(group = sex), alpha = .5) + geom_smooth()
coord_flip() + geom_smooth()
